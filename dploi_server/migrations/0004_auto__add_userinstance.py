...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserInstance'
        db.create_table('dploi_server_userinstance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='instances', to=orm['auth.User'])),
            ('deployment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_instances', to=orm['dploi_server.Deployment'])),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('dploi_server', ['UserInstance'])


    def backwards(self, orm):
        
        # Deleting model 'UserInstance'
        db.delete_table('dploi_server_userinstance')
