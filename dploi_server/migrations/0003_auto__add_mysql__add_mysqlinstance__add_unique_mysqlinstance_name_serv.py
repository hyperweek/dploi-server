...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Mysql'
        db.create_table('dploi_server_mysql', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mysqls', to=orm['dploi_server.Host'])),
            ('is_enabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('port', self.gf('django.db.models.fields.IntegerField')(default=3306)),
        ))
        db.send_create_signal('dploi_server', ['Mysql'])

        # Adding model 'MysqlInstance'
        db.create_table('dploi_server_mysqlinstance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='instances', to=orm['dploi_server.Mysql'])),
            ('deployment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mysql_instances', to=orm['dploi_server.Deployment'])),
        ...
        db.send_create_signal('dploi_server', ['MysqlInstance'])

        # Adding unique constraint on 'MysqlInstance', fields ['name', 'service']
        db.create_unique('dploi_server_mysqlinstance', ['name', 'service_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'MysqlInstance', fields ['name', 'service']
        db.delete_unique('dploi_server_mysqlinstance', ['name', 'service_id'])

        # Deleting model 'Mysql'
        db.delete_table('dploi_server_mysql')

        # Deleting model 'MysqlInstance'
        db.delete_table('dploi_server_mysqlinstance')
