...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInstance.notified'
        db.add_column('dploi_server_userinstance', 'notified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInstance.notified'
        db.delete_column('dploi_server_userinstance', 'notified')
